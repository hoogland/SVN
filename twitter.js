...
if (!window.twttr) {
    ...
    twttr.txt.regexen.latinAccentChars = D("À�?ÂÃÄÅÆÇÈÉÊËÌ�?Î�?�?ÑÒÓÔÕÖØÙÚÛÜ�?Þß� áâãäåæçèéêëìíîïðñòóôõöøùúûüýþş\\303\\277");
                ...
                _getWidgetHtml: function () {
                    ...
                    function AA() {
                        if (y._isProfileWidget) {
                            return '<a target="_blank" href="https://twitter.com/" class="twtr-profile-img-anchor" style="display:none"><img alt="profile" class="twtr-profile-img" src="' + v + '"></a>                      <h3 style="display:none;"></h3>                      <h4 style="display:none;"></h4>'
                        } else {
                    ...
                    var w = '<div class="twtr-doc' + x() + '" style="width: ' + this.wh[0] + ';">            <div class="twtr-hd" style="padding: 2px">' + AA() + '             </div>            <div class="twtr-bd" style="padding: 0 3px">              <div class="twtr-timeline" style="height: 50px;">                <div class="twtr-tweets">                  <div class="twtr-reference-tweet"></div>                  <!-- tweets show here -->                </div>              </div>            </div>            <div class="twtr-ft">              <div  style="padding: 2px; padding-left: 10px"><a target="_blank" href="https://twitter.com"><img alt="" src="' + z + '"></a>                <span><a target="_blank" class="twtr-join-conv" style="color:' + this.theme.shell.color + '" href="https://twitter.com/' + this._getWidgetPath() + '">' + this.footerText + "</a></span>              </div>            </div>          </div>";
                    return w
                },
